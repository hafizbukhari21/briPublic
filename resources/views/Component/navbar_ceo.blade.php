...
$(document).ready(function() {
    ...
    $.ajax({
        type: "GET",
        url: "/ceo/messageNavbar",
        success: function(response) {

            response.map(res => {
                $('.message').append(`<a href='/ceo/message' class="dropdown-item d-flex align-items-center" href="#">
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            response.map(res => {
                $('.taskAlert').append(` <a class="dropdown-item d-flex align-items-center" href="/ceo/taskMonitor">
                        <div class="mr-3">
