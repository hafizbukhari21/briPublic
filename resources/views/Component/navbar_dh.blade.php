    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span
                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{session()->get("sessionKey")["name"]}}</span>
...
$(document).ready(function() {
    ...
    $.ajax({
        type: "GET",
        url: "/divhead/messageNavbar",
        success: function(response) {
            console.log(response)
            response.map(res => {
                $('.message').append(`<a href='/divhead/message' class="dropdown-item d-flex align-items-center" href="#">
    ...
    $.ajax({
        type: "GET",
        url: "/divhead/taskNavbar",
        success: function(response) {
            console.log(response)

            response.map(res => {
                $('.taskAlert').append(` <a class="dropdown-item d-flex align-items-center" href="/divhead/taskMonitor">
                        <div class="mr-3">
