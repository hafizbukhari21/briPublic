                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">DIVISION HEAD</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Regional Decision Support Team <span
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <!-- last pending task-->
                                    <a href="#"><strong>Judul task</strong></a> - divisi | <kbd class="bg-warning">on progress</kbd>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <!-- last send message-->
                                    <a href="#"><strong>Judul pesan</strong></a> - divisi
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias reprehenderit minima reiciendis eligendi, rem error nam vero itaque facilis nobis cum.</p>
                                    ...
                                    - <span class="text-secondary" style="font-size:70%">01/01/2022 08:00</span>
                                    <hr class="sidebar-divider">
                                    <a href="#"><strong>Judul</strong></a> - divisi
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias reprehenderit minima reiciendis eligendi, rem error nam vero itaque facilis nobis cum.</p>
                                    - <span class="text-secondary" style="font-size:70%">01/01/2022 08:00</span>
                                    <hr class="sidebar-divider">
                                    <a href="#"><strong>Judul</strong></a> - divisi
